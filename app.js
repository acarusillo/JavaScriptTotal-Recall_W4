...
Canvas: https://perscholas.instructure.com/courses/1464/pages/week-4-day-2-lecture-slash-lab-slash-hw-js-total-recall?module_item_id=930136
Replit: https://replit.com/@acarusillo/JavaScript-Review-LabW4#script.js

[ A. Q + A ]

(1)How do we assign a value to a variable? A: Use var/let/const.

(2)How do we change the value of a variable? A:Assign a new value to the variable using =. 
Example: myExample = 5;

(3)How do we assign an existing variable to a new variable?
Assign a new value to the variable using =.
Example: myExample = 5;

(4)Remind me, what are declare, assign, and define?
Declare: create a variable using var/let/const.
Assign: give a value to a variable.
Define: write a function with all of the code inside it.

(5)What is pseudocoding and why should you do it?
It's an informal way of writing programming which does not specify its language.
